        ...
        "/articles/{slug}/comments/{id}": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Slug of the article that you want to edit a comment for",
                        "name": "slug",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "integer",
                        "description": "id of the comment that you want to edit a comment for",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Comment you want to edit",
                        "name": "comment",
                        "in": "body",
                        "required": true,
                        "schema": {
